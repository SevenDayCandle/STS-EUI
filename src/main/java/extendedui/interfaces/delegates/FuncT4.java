...
public interface FuncT4<Result, T1, T2, T3, T4> {
    ...
    public static <Result, P, T1, T2, T3> FuncT4<Result, P, T1, T2, T3> get(Class<Result> retType, Class<P> invokeClass, String funcName, Class<T1> param1, Class<T2> param2, Class<T3> param3) throws Throwable {
    ...
    public static <Result, T1, T2, T3, T4> FuncT4<Result, T1, T2, T3, T4> get(Class<Result> retType, Class<?> invokeClass, String funcName, Class<T1> param1, Class<T2> param2, Class<T3> param3, Class<T4> param4) throws Throwable {
        MethodHandles.Lookup lookup = IMPL_LOOKUP.in(invokeClass);
