...
public interface ActionT5<T1, T2, T3, T4, T5> {
    ...
    public static <P, T1, T2, T3, T4> ActionT5<P, T1, T2, T3, T4> get(Class<P> invokeClass, String funcName, Class<T1> param1, Class<T2> param2, Class<T3> param3, Class<T4> param4) throws Throwable {
    ...
    public static <T1, T2, T3, T4, T5> ActionT5<T1, T2, T3, T4, T5> get(Class<?> invokeClass, String funcName, Class<T1> param1, Class<T2> param2, Class<T3> param3, Class<T4> param4, Class<T5> param5) throws Throwable {
        MethodHandles.Lookup lookup = IMPL_LOOKUP.in(invokeClass);
