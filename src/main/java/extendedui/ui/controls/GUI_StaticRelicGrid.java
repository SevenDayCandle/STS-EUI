...
public class GUI_StaticRelicGrid extends GUI_RelicGrid
{
    protected int currentRow;
    public int visibleRowCount = 20;

    public GUI_StaticRelicGrid()
    {
        this(0.5f, true);
    }

    public GUI_StaticRelicGrid(float horizontalAlignment)
    {
        this(horizontalAlignment, true);
    }

    public GUI_StaticRelicGrid(float horizontalAlignment, boolean autoShowScrollbar)
    {
