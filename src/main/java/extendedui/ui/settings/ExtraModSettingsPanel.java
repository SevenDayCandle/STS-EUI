...
public class ExtraModSettingsPanel extends EUIBase {
    ...
    protected final EUIButtonList buttons = new EUIButtonList(7, screenW(0.077f), hb.y + scale(700), EUIButtonList.BUTTON_W, EUIButtonList.BUTTON_H).setFontScale(0.6f);
