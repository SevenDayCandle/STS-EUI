...
import stseffekseer.interfaces.markers.CustomFilter;
import stseffekseer.ui.GUI_Base;
import stseffekseer.ui.controls.*;
...
import stseffekseer.utilities.Mathf;
import stseffekseer.utilities.abstracts.FakeLibraryCard;
import stseffekseer.utilities.abstracts.TooltipCard;
...
public class CardKeywordFilters extends GUI_Base
{
    ...
    public CardKeywordFilters()
    {
        ...
        OriginsDropdown = new GUI_Dropdown<ModInfo>(new AdvancedHitbox(hb.x - SPACING * 3, hb.y + SPACING * 3, Scale(240), Scale(48)), c -> c == null ? "--" : c.Name)
